    ...
    <div class="editP">
      ...
      <form action="" class="editForm">
        <div class="imageW">
          ...
          <img :src="user.avatar==='http://api.hamomhim.coelix.online/null'? '/static/images/profile/defaultAvatar.png': user.avatar "
        ...
        <div class="textFields">
          ...
          <div class="column cRight">
            ...
            <span>קטגוריות</span>
            <div class="selectWrapper">
              <drop-down class="dropDown" placeholder="נא בחר קטגוריה אחת" v-model="categories.value"
                         v-bind="categories"/>
            </div>
            <span>פקס</span>
        ...
        <button class="sendData th-btn th-btn-blue th-btn-sm" ref="sendData" style="text-align:center"
                @click="openModal">שמור
        </button>
      </form>
    </div>
