  ...
  <div class="profile-wrapper" ref="nav">
    ...
    <div class="profile-about" id="resume">
     <div class="image-wrapper">
      ...
      <div v-if="user.facebook || user.youtube || user.whatsapp" class="socials-element">
        ...
        <a :href="user.youtube" v-if="user.youtube">
        ...
        <a :href="user.whatsapp" v-if="user.whatsapp">
          <svg width="35" height="35" viewBox="0 0 35 35" fill="none" xmlns="http://www.w3.org/2000/svg">
            <path d="M17.5232 0.0673828H17.5145C7.9299 0.0673828 0.135742 7.86371 0.135742 17.4505C0.135742 21.253 1.36125 24.7775 3.44505 27.6392L1.27868 34.097L7.96032 31.961C10.709 33.7819 13.9879 34.8336 17.5232 34.8336C27.1078 34.8336 34.902 27.0351 34.902 17.4505C34.902 7.86588 27.1078 0.0673828 17.5232 0.0673828Z" fill="#2F80ED"/>
            <path d="M27.6377 24.4637C27.2183 25.6479 25.5539 26.6301 24.2262 26.9169C23.318 27.1103 22.1316 27.2646 18.1378 25.6088C13.0293 23.4924 9.73959 18.3014 9.48319 17.9646C9.23765 17.6278 7.41895 15.2159 7.41895 12.7214C7.41895 10.2269 8.68574 9.0123 9.19637 8.49081C9.61574 8.06275 10.3089 7.86719 10.9738 7.86719C11.1889 7.86719 11.3823 7.87805 11.5561 7.88674C12.0668 7.90847 12.3232 7.93889 12.66 8.74504C13.0793 9.75543 14.1006 12.2499 14.2223 12.5063C14.3461 12.7627 14.47 13.1104 14.2961 13.4472C14.1332 13.7948 13.9898 13.9491 13.7334 14.2446C13.477 14.5401 13.2336 14.7661 12.9772 15.0834C12.7425 15.3593 12.4774 15.6548 12.7729 16.1655C13.0685 16.6652 14.0897 18.3318 15.5934 19.6703C17.5337 21.3978 19.1069 21.9497 19.6697 22.1844C20.0891 22.3582 20.5888 22.3169 20.8952 21.991C21.2841 21.5716 21.7644 20.8763 22.2533 20.1918C22.6009 19.7007 23.0398 19.6399 23.5005 19.8137C23.9698 19.9767 26.4534 21.2044 26.9641 21.4586C27.4747 21.715 27.8115 21.8367 27.9354 22.0518C28.057 22.2669 28.057 23.2773 27.6377 24.4637Z" fill="white"/>
          </svg>
        </a>
      </div>
...
export default {
  ...
  mounted() {
    ...
    .then((response)=>{
      ...
      for(const property in response.data.value.user){
        if(response.data.value.user[property] === 'null'){
          response.data.value.user[property] = false;
        }
      }
