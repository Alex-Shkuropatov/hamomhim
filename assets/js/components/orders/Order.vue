  ...
  <div class="order-item">
    ...
    <div class="content-wrapper">
      ...
      <div class="text-wrapper">
        ...
        <button class="sendData th-btn th-btn-blue th-btn-sm" @click.prevent="searchWorkers"    > קרא את הפוסט הזה  &nbsp;&nbsp;&nbsp;&nbsp;   +</button>
      </div>
  ...
  export default {
    ...
    methods: {
      ...
      searchWorkers(){
        ...
        this.$store.commit('modals/showOrder/saveData', this.order );
        this.$router.push({name: 'search-workers',
          params:
              {'orderId' : this.id,
                 'order' : this.order}
        });
