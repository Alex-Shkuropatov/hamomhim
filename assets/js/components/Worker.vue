    ...
    <div class="content-block">
     ...
     <div class="content">
       <div class="content-info">
         ...
         <div class="type"><span class="bold"> תוחמתה גוס:</span><span>{{type}}</span><span class="small">תוריד \ תויונח | עקרק תיב </span> </div>
         <hr>
         <div class="description">
           {{description}}
         </div>
        <div class="footer-wrapper">
          <a :href="url" class="th-btn th-btn-blue th-btn-sm contact-button"> רשק רוצ </a>
          <div class="location">
